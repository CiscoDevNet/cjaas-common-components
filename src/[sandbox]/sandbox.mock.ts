...
export const latestFormattedEventsFromWidget = [
  ...
  {
    id: "540ee1c1-2daf-484c-9b98-47f2e1a4f1f6",
    specversion: "1.0",
    type: "task:new",
    source: "custom/269953d3-6e08-496c-8790-ebcb457fb1eb",
    time: "2023-11-14T13:40:55.725Z",
    ...
    renderingData: {
      ...
      subTitle: "Passed",
      iconType: "Information",
      eventSource: "custom/269953d3-6e08-496c-8790-ebcb457fb1eb",
      isActive: false,
      filterTags: ["call", "finance"],
    },
  },
  {
    ...
    specversion: "1.0",
    type: "empath:data",
    source: "/com/cisco/wxcc/0cfd49e6-5ea6-4637-a197-80436f7e4d33",
    time: "2023-10-12T19:35:38.526Z",
    identity: "4083866332",
    identitytype: "phone",
    previousidentity: null,
    datacontenttype: "application/json",
    data: {
      aggCustomerScore: 4.363636363636363,
      overallSentiment: "Negative",
      sentiment: [
        {
          sentiment: "neutral",
          probability: 0.7922711372375488,
          speaker: "customer",
          cummulativeScore: 0,
          utterance: "Hi, my name is now this is regarding your phone. I purchased from you. ",
        },
        {
          sentiment: "positive",
          probability: 0.671207070350647,
          speaker: "agent",
          cummulativeScore: 0.06535947712418301,
          utterance: "Thank you for calling Webex contact center. How may I help you? ",
        },
        {
          sentiment: "neutral",
          probability: 0.7875544428825378,
          speaker: "agent",
          cummulativeScore: 0.06535947712418301,
          utterance:
            "Sure, just now. All right, so I'll need to verify your identity before we proceed. I'll need to, I'll lead the last four digits of your social security number. Can you please provide me with that?",
        },
        {
          sentiment: "negative",
          probability: 0.8781811594963074,
          speaker: "customer",
          cummulativeScore: -0.06535947712418301,
          utterance: "It's not working love. It's just been a week and it's not working now. ",
        },
        {
          sentiment: "neutral",
          probability: 0.9034367203712463,
          speaker: "customer",
          cummulativeScore: -0.06535947712418301,
          utterance: "Mm- hmm. ",
        },
        {
          sentiment: "neutral",
          probability: 0.5930092334747314,
          speaker: "customer",
          cummulativeScore: -0.06535947712418301,
          utterance: "It's double three double three. Yeah, it's one.",
        },
        {
          sentiment: "neutral",
          probability: 0.6489084362983704,
          speaker: "agent",
          cummulativeScore: -0.06535947712418301,
          utterance: "All right, thank you. Verify your identity. Can you give me the exact order number? ",
        },
        {
          sentiment: "neutral",
          probability: 0.7492576837539673,
          speaker: "customer",
          cummulativeScore: -0.06535947712418301,
          utterance: "Double sixty eight, seven, eight. ",
        },
        {
          sentiment: "neutral",
          probability: 0.7086139917373657,
          speaker: "agent",
          cummulativeScore: -0.06535947712418301,
          utterance:
            "All right, thank you. Have pulled up the order. I see the purchase was made seven days ago. Can you give me more details about the issues that you are facing? I'll be short, document it on my side. ",
        },
        {
          sentiment: "negative",
          probability: 0.9000136852264404,
          speaker: "customer",
          cummulativeScore: -0.39215686274509803,
          utterance:
            "Mm- hmm So one of them, like it's like one of the earphones is not working. It just stopped working like after two days of using it, and it's not acceptable for sure. Does a new one. And we had high expectations from. ",
        },
        {
          sentiment: "neutral",
          probability: 0.8281971216201782,
          speaker: "customer",
          cummulativeScore: -0.39215686274509803,
          utterance: "Happen. ",
        },
        {
          sentiment: "neutral",
          probability: 0.5812777876853943,
          speaker: "agent",
          cummulativeScore: -0.39215686274509803,
          utterance:
            "All right, I can, I can send you product is under warranty. I can, I can replace the same product and you should get the replacement within. ",
        },
        {
          sentiment: "neutral",
          probability: 0.7438828349113464,
          speaker: "customer",
          cummulativeScore: -0.39215686274509803,
          utterance: "Okay. ",
        },
        {
          sentiment: "neutral",
          probability: 0.6697767376899719,
          speaker: "agent",
          cummulativeScore: -0.39215686274509803,
          utterance:
            "Forty dollars would that work for you. All right, I'll go ahead and initiate the full refund. You should be getting the money back into your credit card account within the next forty- eight hours. ",
        },
        {
          sentiment: "negative",
          probability: 0.8357736468315125,
          speaker: "customer",
          cummulativeScore: -0.8823529411764706,
          utterance: "No, I, I don't think I'm interested in that. I would like a full refund.",
        },
        {
          sentiment: "positive",
          probability: 0.8375825881958008,
          speaker: "customer",
          cummulativeScore: -0.3594771241830065,
          utterance: "Okay, thank you. ",
        },
        {
          sentiment: "positive",
          probability: 0.8344848155975342,
          speaker: "agent",
          cummulativeScore: 0.1960784313725491,
          utterance: "Thank you.",
        },
      ],
      queueId: "81350cc8-7e99-4146-83e3-a52de2cf92b7",
      aggAgentScore: 6.428571428571429,
      channelType: "telephony",
      orgId: "a5b3eae5-f59a-4b4d-bfbb-8f06b32d91f7",
      agentSentiment: "Negative",
      queueName: "Q_arubhatt",
      aggSessionScore: 0.1960784313725491,
      recUrl:
        "https://cjp-ccone-produs1-media-storage-recording.s3.amazonaws.com/3f4ac69f-e86a-4d6a-b016-f0b0b7445c1d/917eb9f3-225a-4a70-b18d-4d7e65f0e8cc/917eb9f3-225a-4a70-b18d-4d7e65f0e8cc/combinedRecordings.wav?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Date=20231012T182208Z&X-Amz-SignedHeaders=host&X-Amz-Expires=3600&X-Amz-Credential=AKIATRZUOXQOKWHH6JML%2F20231012%2Fus-east-1%2Fs3%2Faws4_request&X-Amz-Signature=420603d4e9382821475def237d2a752064efe7b5d59cc1f9b9fffa233971e1f7",
      taskId: "917eb9f3-225a-4a70-b18d-4d7e65f0e8cc",
  ...
  },
  {
    ...
    renderingData: {
      title: "inbound chat",
      subTitle:
        "testing a very long sub title, and now we will see if the ellipsis is working correctly. let's keep trying to test the subTitle.",
      iconType: "chat",
      channelTypeTag: "chat",
      eventSource: "wxcc",
    },
