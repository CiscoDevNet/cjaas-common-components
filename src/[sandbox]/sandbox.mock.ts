...
export const testingHistoricalEvents: Timeline.CustomerEvent[] = [
  {
    ...
    time: "2023-08-02T11:56:41.976-06:00",
    ...
    data: {
      ...
      origin: "+14806754084",
      destination: "+12145046961",
      createdTime: 1691002601839,
  ...
  },
  {
    ...
    type: "task:new",
    source: "wxcc",
    time: "2023-08-02T12:56:41.976-06:00",
    identity: "12145046961",
    identitytype: "phone",
    previousidentity: null,
    datacontenttype: "application/json",
    data: {
      queueId: "60a576ca-147a-41b1-9114-55074a08d398",
      origin: "+14806754084",
      destination: "+12145046961",
      createdTime: 1691002601839,
      channelType: "telephony",
      taskId: "fec0c4cd-1c7e-4f0e-8559-17828ca67c9e",
      direction: "OUTBOUND",
    },
  },
  {
    ...
    type: "task:new",
    source: "wxcc",
    time: "2023-08-01T12:56:41.976-06:00",
